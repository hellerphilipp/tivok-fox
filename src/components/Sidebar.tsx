            ...
            <div className="w-64 px-8 py-4 bg-gray-100 border-r">
                ...
                <nav className="mt-10">
                    ...
                    <div className="mt-2 -mx-3 mb-8">
                        ...
                        <SidebarLink href="#" active={this.props.page=="tickets"}>Tickets & pricing</SidebarLink>
                    </div>
                    <SidebarHeading>Manage</SidebarHeading>
                    <div className="mt-2 -mx-3">
                        <SidebarLink href="#" active={this.props.page=="orders"}>Orders</SidebarLink>
                        <SidebarLink href="#" active={this.props.page=="guests"}>Guest list</SidebarLink>
                    </div>
                </nav>
            </div>
        );
